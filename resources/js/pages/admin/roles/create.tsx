...
export default function RoleCreate({ resources, actions, allPermissions }: Props) {
                    ...
                    <div className="grid gap-4 rounded-lg border p-6">
                        ...
                        <div className="grid gap-2 mt-4">
                            ...
                            <p className="text-muted-foreground text-sm mb-2">
                                Check the boxes below to grant access. You can click on the row or column headers to toggle all.
                            </p>
